...
if __name__=="__main__":
    ...
    print("===> New Model")
    model = LNLP_SMENet(Ch=28, stages=8, size=256)
    ...
    parser.add_argument('--data_path', default='./train/', type=str,help='Path of data')
    parser.add_argument('--mask_path', default='./mask.mat', type=str,help='Path of mask')
